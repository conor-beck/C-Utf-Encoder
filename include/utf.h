...
void from_utf16be_to_utf16le(int infile, int outfile);
void from_utf16le_to_utf16be(int infile, int outfile);
void from_utf16le_to_utf8(int infile, int outfile);
void from_utf16be_to_utf8(int infile, int outfile);
void transcribe(int infile, int outfile);

void get_encoding_function(int infile, int outfile);
...
utf16_glyph_t* code_point_to_utf16le_glyph(code_point_t code_point, utf16_glyph_t* ptr);
utf16_glyph_t* code_point_to_utf16be_glyph(code_point_t code_point, utf16_glyph_t* ptr);
